...
from sections.profil_section_ENG import get_profile_text, get_experience1_text, get_experience2_text, get_experience3_text, get_experience4_text, get_experience5_text, get_experience6_text, get_experience7_text, get_experience8_text, get_experience9_text
from sections.short_section_ENG import get_nazwisko_text, get_skills_data, get_coding_data,get_languages_data, get_kontakt_text, get_edukacja_text, get_hobby_text
...
def get_short_table(col1_width, styles):
    short_table_data = [
        ...
        [create_rating_section("SKILLS", get_skills_data(), styles, col1_width)],
        [create_rating_section("PROGRAMMING", get_coding_data(), styles, col1_width)],
        [create_rating_section("LANGUAGES", get_languages_data(), styles, col1_width)],
...
def get_long_table(col2_width, styles):
    long_table_data = [
        [Paragraph("PROFILE", styles['PolishTitle'])],
        [get_profile_text(styles)],
        [Paragraph("EXPERIENCE", styles['PolishTitle'])],
